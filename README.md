...
| <kbd>Alt</kbd> + <kbd>b</kbd>            | ∫ telescope buffers                     | n     |
| <kbd>Alt</kbd> + <kbd>f</kbd>            | ƒ telescope find_files                  | n     |
| <kbd>Alt</kbd> + <kbd>g</kbd>            | © telescope git_files                   | n     |
| <kbd>Alt</kbd> + <kbd>r</kbd>            | ® telescope live_grep                   | n     |
| <kbd>Alt</kbd> + <kbd>s</kbd>            | ß `CocFzfList symbols`                  | n     |
| <kbd>Ctrl-x</kbd> + <kbd>Ctrl-l</kbd>    | `CocFzfList`                            | n     |
| <kbd>Leader</kbd> + <kbd>y</kbd>         | `CocList` yank                          | n     |
| <kbd>Ctrl-Shift</kbd> + <kbd>Up</kbd>    | `vista` list `fzf`                      | n     |
| <kbd>Ctrl-Shift</kbd> + <kbd>Left</kbd>  | `:bprevious`                            | n     |
| <kbd>Ctrl-Shift</kbd> + <kbd>Right</kbd> | `:bnext`                                | n     |
| <kbd>gt</kbd>                            | `:bnext`                                | n     |
| <kbd>gT</kbd>                            | `:bprevious`                            | n     |
| <kbd>ff</kbd>                            | open and close fold                     | n     |
| <kbd>fl</kbd>                            | open and close all folds                | n     |
| <kbd>+</kbd>                             | vertical resize +5                      | n     |
| <kbd>-</kbd>                             | vertical resize -5                      | n     |
| <kbd>s+</kbd>                            | resize +5                               | n     |
| <kbd>s-</kbd>                            | resize -5                               | n     |
| <kbd>nt</kbd>                            | `:setl noexpandtab`                     | n     |
| <kbd>re</kbd>                            | retab selection                         | v     |
| <kbd>qc</kbd>                            | quckfix close                           | n     |
