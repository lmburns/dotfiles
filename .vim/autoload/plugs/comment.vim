fun! plugs#comment#nerdcomment_maps() abort
    nnoremap <silent> <C-.> <Cmd>call nerdcommenter#Comment(0, "Toggle")<CR>j
    xnoremap <silent> <C-.> <Cmd>call nerdcommenter#Comment(0, "Toggle")<CR>'>j
    xnoremap <silent><nowait> gc <Cmd>call nerdcommenter#Comment(0, "Toggle")<CR>
    xnoremap <silent> gcc <Cmd>call nerdcommenter#Comment(0, "Toggle")<CR>
    nnoremap <silent> gcl <Cmd>call nerdcommenter#Comment(0, "AlignLeft")<CR>
    xnoremap <silent> gcl <Cmd>call nerdcommenter#Comment(0, "AlignLeft")<CR>
    nnoremap <silent> gcr <Cmd>call nerdcommenter#Comment(0, "AlignRight")<CR>
    xnoremap <silent> gcr <Cmd>call nerdcommenter#Comment(0, "AlignRight")<CR>
    " nnoremap <silent> gcr <Cmd>call nerdcommenter#Comment(0, "AlignBoth")<CR>
    " xnoremap <silent> gcr <Cmd>call nerdcommenter#Comment(0, "AlignBoth")<CR>
    nnoremap <silent> gcL <Cmd>call nerdcommenter#Comment(0, "ToEOL")<CR>
    nnoremap <silent> gcA <Cmd>call nerdcommenter#Comment(0, "Append")<CR>
    nnoremap <silent> gcy <Cmd>call nerdcommenter#Comment(0, "Yank")<CR>
    xnoremap <silent> gcy <Cmd>call nerdcommenter#Comment(0, "Yank")<CR>
    nnoremap <silent> gcn <Cmd>call nerdcommenter#Comment(0, "Nested")<CR>
    xnoremap <silent> gcn <Cmd>call nerdcommenter#Comment(0, "Nested")<CR>
    nnoremap <silent> gcv <Cmd>call nerdcommenter#Comment(0, "Invert")<CR>
    xnoremap <silent> gcv <Cmd>call nerdcommenter#Comment(0, "Invert")<CR>
    nnoremap <silent> gcx <Cmd>call nerdcommenter#Comment(0, "Sexy")<CR>
    xnoremap <silent> gcx <Cmd>call nerdcommenter#Comment(0, "Sexy")<CR>
endfun
