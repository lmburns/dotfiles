func! plugs#gutentags#setup() abort
    ...
    let g:gutentags_file_list_command = {
        \ 'markers': {
        \   '.git': 'git ls-files',
        \   '.root': 'fd --color=never --strip-cwd-prefix --type f'
        \            .. '--hidden --follow --exclude=.git --exclude=.github',
        \ }}

    let g:gutentags_modules = ['ctags']
    let g:gutentags_exclude_project_root = ['/opt', '/mnt', '/media', '/usr/local', '/etc', '/tmp']
