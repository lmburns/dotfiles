...
fun! plugs#go#autocmds() abort
    augroup lmb__GoEnv
        au!
        au FileType go
                    \ setl nolist|
                    \ call plugs#go#mappings()|
                    \ call plugs#go#commands()
    augroup END
endfun

fun! plugs#go#setup() abort
