...
alias ninitv='/usr/bin/vim $XDG_CONFIG_HOME/nvim/vimscript/plug.vim'
alias ninitp='pvim $XDG_CONFIG_HOME/nvim/vimscript/plug.vim'
alias ninit='$EDITOR $XDG_CONFIG_HOME/nvim/vimscript/plug.vim'
