...
nmap <silent> -   <Plug>(mkdx-demote-header)
nmap <silent> =   <Plug>(mkdx-promote-header)
nmap <silent> gT  <Plug>(mkdx-tableize)
nmap <silent> gln <Plug>(mkdx-checkbox-next)
nmap <silent> glm <Plug>(mkdx-checkbox-prev)
nmap <silent> gli <Plug>(mkdx-toggle-checkbox)
nmap <silent> glx <Plug>(mkdx-toggle-checklist)
nmap <silent> gl, <Plug>(mkdx-toggle-list)
