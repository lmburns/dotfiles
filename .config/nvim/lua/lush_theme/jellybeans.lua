...
local theme =
    ...
    function()
        return {
            ...
            Function {fg = goldenrod, gui = "bold"}, -- function name (also: methods for classes)
            ...
            Type {fg = koromiko, gui = "NONE"}, -- (preferred) int, long, char, etc.
            ...
            LspDiagnosticsVirtualTextError {
                ...
                bg = old_brick.darken(72)
            }, -- Used for "Error" diagnostic virtual text
            LspDiagnosticsVirtualTextWarning {
                LspDiagnosticsDefaultWarning,
                bg = koromiko.darken(88)
            ...
            LspDiagnosticsVirtualTextHint {
                ...
                bg = tea_green.darken(90)
            }, -- Used for "Hint" diagnostic virtual text
            LspDiagnosticsUnderlineError {
                sp = old_brick.lighten(20),
                gui = "undercurl"
            ...
            TelescopeSelection {
                fg = ship_cove.lighten(46),
                bg = ship_cove.darken(74)
            },
            ...
            CocErrorHighlight {gui = "NONE", sp = raw_sienna},
            CocWarningHighlight {gui = "none", sp = koromiko},
            CocInfoHighlight {gui = "NONE", sp = tea_green},
            CocHintHighlight {gui = "NONE", sp = perano},
            CocErrorVirtualText {fg = grey},
            CocWarningVirtualText {fg = grey},
            CocInfoVirtualText {fg = grey},
            CocHintVirtualText {fg = grey},
            CocCodeLens {fg = grey},
            CocUnusedHighlight {fg = grey}
        }
    end
)
