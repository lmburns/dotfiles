...
local function init()
    ...
    vim.defer_fn(
        function()
            ...
            map("n", "zh", it(ufo.goPreviousStartFold), {desc = "Previous start fold"})
            map("n", "z,", it(ufo.goPreviousClosedFold), {desc = "Previous closed fold"})
            map("n", "z.", it(ufo.goNextClosedFold), {desc = "Next closed fold"})
