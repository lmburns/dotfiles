...
function M.init()
    ...
    map("n", "<C-x><C-s>", "CocFzfList symbols", {desc = "CocFzf: workspace symbols"})
    map("n", "<C-x><C-o>", "CocFzfList outline", {desc = "CocFzf: workspace outline"})
    map("n", "<C-x><C-l>", "CocFzfList", {desc = "CocFzf: list commands"})
