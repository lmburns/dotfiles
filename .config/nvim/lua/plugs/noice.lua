...
function M.setup()
    ...
    -- cleared      boolean         checks if msg is cleared, meaning it’s in the history
    -- cmdline      boolean|string  checks if msg generated by exec cmdline. (string=pattern)
    -- error        boolean         all error-like kinds from ext_msgs
    -- event        string|string[] any of the events from ext_msgs or cmdline. See ui-messages
    -- find         string          uses lua string.find to match the pattern
    -- has          boolean         checks if the msg is exists, meaning it’s in the history
    -- kind         string|string[] any of the kinds from ext_msgs. See :h ui-messages
    -- max_height   number          maximum height of the msg
    -- max_length   number          maximum length of the msg (total width of all lines)
    -- max_width    number          maximum width of the msg
    -- min_height   number          minimum height of the msg
    -- min_length   number          minimum length of the msg (total width of all the lines)
    -- min_width    number          minimum width of the msg
    ...
    local routes = {
        ...
        --  │ Confirm │
        --  ╰─────────╯
        {view = "confirm", filter = {find = "OK to remove"}},
        --  ╭──────╮
        --  │ Rest │
        --  ╰──────╯
        {
