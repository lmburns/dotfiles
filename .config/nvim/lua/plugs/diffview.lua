...
function M.setup()
    ...
    diffview.setup({
        ...
        keymaps = {
            ...
            file_panel = {
                {"n", "j", act.next_entry, {desc = "Goto next file"}},
                {"n", "<Down>", act.next_entry, {desc = "Goto next file"}},
                {"n", "k", act.prev_entry, {desc = "Goto prev file"}},
                {"n", "<Up>", act.prev_entry, {desc = "Goto prev file entry"}},
                ...
                {"n", "-", act.toggle_stage_entry, {desc = "Stage (toggle) selected entry"}},
                {"n", "s", act.toggle_stage_entry, {desc = "Stage (toggle) selected entry"}},
                {"n", "u", act.toggle_stage_entry, {desc = "Stage (toggle) selected entry"}},
                ...
                {"n", "z;", act.toggle_fold, {desc = "Toggle fold"}},
                ...
                {"n", "<C-w>s", act.goto_file_split, {desc = "Open file in a new split"}},
                {"n", "<C-w>T", act.goto_file_tab, {desc = "Open file in a new tabpage"}},
                ...
                {"n", "g<C-x>", act.cycle_layout, {desc = "Cycle available layouts"}},
                {"n", "<Leader>R", act.cycle_layout, {desc = "Cycle available layouts"}},
                {"n", "[x", act.prev_conflict, {desc = "Prev conflict"}},
                {"n", "]x", act.next_conflict, {desc = "Next conflict"}},
                {"n", "[n", act.prev_conflict, {desc = "Prev conflict"}},
                {"n", "]n", act.next_conflict, {desc = "Next conflict"}},
            ...
            file_history_panel = {
                ...
                {"n", "zR", act.open_all_folds, {desc = "Expand all folds"}},
                {"n", "zM", act.close_all_folds, {desc = "Collapse all folds"}},
                {"n", "j", act.next_entry, {desc = "Goto next file entry"}},
                {"n", "<down>", act.next_entry, {desc = "Goto next file entry"}},
                {"n", "k", act.prev_entry, {desc = "Goto prev file entry"}},
                {"n", "<up>", act.prev_entry, {desc = "Goto prev file entry"}},
                {"n", "<cr>", act.select_entry, {desc = "Open diff for selected entry"}},
                {"n", "o", act.select_entry, {desc = "Open diff for selected entry"}},
                {"n", "l", act.select_entry, {desc = "Open diff for selected entry"}},
