...
function M.restore()
  if vim.v.event.operator == "y" and last_wv and api.nvim_get_current_win() ==
      winid and api.nvim_get_current_buf() == bufnr then
...
local function init()
  autocmd(
      "TextYank", [[TextYankPost * lua require('common.yank').restore()]], true
  )
end
