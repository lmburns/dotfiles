...
local function init()
    ...
    Abbr:new("c", "PI", "PackerInstall", {only_start = true})
    Abbr:new("c", "PU", "PackerUpdate", {only_start = true})
    Abbr:new("c", "PS", "PackerSync", {only_start = true})
    Abbr:new("c", "PC", "PackerCompile", {only_start = true})

    Abbr:new("c", "lreq", "lua require('")
    Abbr:new("c", "lpr", "lua p('")

    Abbr:new("c", "tel", "Telescope", {only_start = true})
    Abbr:new("c", "Review", "DiffviewOpen", {only_start = true})
    Abbr:new("c", "ld", "Linediff", {only_start = true})
    Abbr:new("c", "noice", "Noice", {only_start = true})
    Abbr:new("c", "bufr", "Bufferize", {only_start = true})
    Abbr:new("c", "bufl", "Bufferize lua", {only_start = true})

    Abbr:new("c", "man", "Man", {only_start = true})
    ...
    Abbr:new("c", "gr", "Grep", {only_start = true})
    Abbr:new("c", "lg", "LGrep", {only_start = true})
    Abbr:new("c", "hgr", "helpgrep", {only_start = false})
    Abbr:new("c", "helpg", "helpgrep", {only_start = false})
    Abbr:new("c", "fil", "filter", {only_start = true})
