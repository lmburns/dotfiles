...
_G.packer_plugins = {
  ...
  UnconditionalPaste = {
    keys = { { "n", "gcp" }, { "n", "gcP" }, { "n", "glp" }, { "n", "glP" }, { "n", "gbp" }, { "n", "gbP" }, { "n", "gap" }, { "n", "g]p" }, { "n", "g]P" }, { "n", "g[p" }, { "n", "g[P" }, { "n", "gsp" }, { "n", "gsP" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["coc.nvim"] = {
    after = { "coc-kvs", "coc-code-action-menu", "coc-wxy", "coc-fzf" },
    loaded = true,
    only_config = true
  },
  ["comment-box.nvim"] = {
  ...
  kimbox = {
    after = { "vimwiki", "nvim-scrollbar", "nvim-notify", "bufferline.nvim", "lualine.nvim", "telescope.nvim", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "telescope-dap.nvim", "nvim-dap-python" },
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "todo-comments.nvim", "telescope-fzf-native.nvim", "telescope-ultisnips.nvim", "telescope-bookmarks.nvim", "telescope-hop.nvim", "telescope-heading.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "project.nvim", "telescope-github.nvim", "telescope-coc.nvim", "telescope-rualdi.nvim", "telescope-ghq.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-packer.nvim", "nvim-dap", "lazygit.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-luaref', 'nlua.nvim', 'lua-dev.nvim', 'nvim-luapad', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
