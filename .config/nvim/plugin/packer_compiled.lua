...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-notify", "nvim-scrollbar", "telescope.nvim", "bufferline.nvim", "lf.nvim", "vimwiki", "lualine.nvim" },
