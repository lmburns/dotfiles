...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "bufferline.nvim", "lualine.nvim", "telescope.nvim", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-ghq.nvim", "telescope-packer.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "nvim-neoclip.lua", "telescope-bookmarks.nvim", "telescope-github.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdx', 'vim-markdown', 'vim-table-mode', 'nvim-colorizer.lua', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
