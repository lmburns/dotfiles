...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "bufferline.nvim", "indent-blankline.nvim", "lualine.nvim", "telescope.nvim", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-rualdi.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-bookmarks.nvim", "telescope-ui-select.nvim", "telescope-ghq.nvim", "telescope-ultisnips.nvim", "telescope-file-browser.nvim", "telescope-coc.nvim", "nvim-dap", "telescope-github.nvim", "telescope-packer.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-zoxide" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-markdown', 'vim-table-mode', 'mkdx', 'vim-pandoc-syntax'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-luapad', 'nlua.nvim', 'luv-vimdocs', 'nvim-colorizer.lua', 'nvim-luaref'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'vim-table-mode', 'mkdx', 'vim-pandoc-syntax', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
