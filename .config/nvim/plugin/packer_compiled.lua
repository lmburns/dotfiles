...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "bufferline.nvim", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-github.nvim", "nvim-neoclip.lua", "telescope-frecency.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-ultisnips.nvim", "telescope-ghq.nvim", "telescope-fzf-native.nvim" },
