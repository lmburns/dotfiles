...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "indent-blankline.nvim", "nvim-scrollbar", "bufferline.nvim", "vimwiki", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nordic.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/nordic.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ultisnips.nvim", "telescope-ui-select.nvim", "telescope-bookmarks.nvim", "telescope-zoxide", "telescope-ghq.nvim", "telescope-smart-history.nvim", "telescope-rualdi.nvim", "telescope-fzf-native.nvim", "urlview.nvim", "nvim-dap", "telescope-file-browser.nvim", "lazygit.nvim", "telescope-frecency.nvim", "telescope-hop.nvim", "telescope-heading.nvim", "telescope-packer.nvim", "telescope-coc.nvim", "telescope-github.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'mkdx', 'vim-table-mode', 'vim-pandoc-syntax', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdx', 'vim-table-mode', 'vim-pandoc-syntax', 'vim-markdown', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'lua-dev.nvim', 'nvim-luapad', 'luv-vimdocs', 'nvim-luaref', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
