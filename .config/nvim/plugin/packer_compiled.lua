...
_G.packer_plugins = {
  ...
  ["grapple.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/grapple.nvim",
  ...
  kimbox = {
    after = { "indent-blankline.nvim", "telescope.nvim", "bufferline.nvim", "nvim-scrollbar", "lf.nvim", "vimwiki", "nvim-notify", "lualine.nvim" },
  ...
  ["nvim-tundra"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/nvim-tundra",
  ...
  ["portal.nvim"] = {
    config = { "require('plugs.portal')" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/portal.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "telescope-bookmarks.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-ultisnips.nvim", "telescope-github.nvim", "telescope-heading.nvim", "telescope-smart-history.nvim", "lazygit.nvim", "telescope-frecency.nvim", "nvim-dap", "telescope-rualdi.nvim", "todo-comments.nvim", "telescope-ghq.nvim", "telescope-coc.nvim", "project.nvim", "telescope-packer.nvim", "telescope-zoxide" },
...
require('plugs.config').table_mode()
...
pcall(vim.api.nvim_create_user_command, 'ScratchPad', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'ScratchPad'}, { cmd = 'ScratchPad' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Linediff', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'linediff.vim'}, { cmd = 'Linediff' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DiffviewLog', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'diffview.nvim'}, { cmd = 'DiffviewLog' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DiffviewRefresh', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'diffview.nvim'}, { cmd = 'DiffviewRefresh' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'SudaRead', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'suda.vim'}, { cmd = 'SudaRead' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'SudaWrite', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'suda.vim'}, { cmd = 'SudaWrite' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Grepper', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-grepper'}, { cmd = 'Grepper' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'GrepperRg', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-grepper'}, { cmd = 'GrepperRg' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'VMSearch', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-visual-multi'}, { cmd = 'VMSearch' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Luapad', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'nvim-luapad'}, { cmd = 'Luapad' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Flogsplit', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-flog'}, { cmd = 'Flogsplit' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Info', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'info.vim'}, { cmd = 'Info' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Vinfo', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vinfo'}, { cmd = 'Vinfo' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'E2v', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'eregex.vim'}, { cmd = 'E2v' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'VinfoNext', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vinfo'}, { cmd = 'VinfoNext' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'VinfoPrevious', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vinfo'}, { cmd = 'VinfoPrevious' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'LuaRun', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'nvim-luapad'}, { cmd = 'LuaRun' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'VinfoClean', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vinfo'}, { cmd = 'VinfoClean' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Sort', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'sort.nvim'}, { cmd = 'Sort' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'M', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'eregex.vim'}, { cmd = 'M' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'LiveEasyAlign', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-easy-align'}, { cmd = 'LiveEasyAlign' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'S', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'eregex.vim'}, { cmd = 'S' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Bufferize', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'bufferize.vim'}, { cmd = 'Bufferize' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'PP', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'paperplanes.nvim'}, { cmd = 'PP' }, _G.packer_plugins)
