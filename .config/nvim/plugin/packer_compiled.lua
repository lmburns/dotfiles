...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "telescope.nvim", "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim.lua"] = {
    config = { "\27LJ\2\n(\0\0\3\0\2\0\0056\0\0\0'\2\1\0B\0\2\0027\0\1\0K\0\1\0\tnvim\frequire\0" },
    loaded = true,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-rualdi.nvim", "telescope-ui-select.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "telescope-smart-history.nvim", "telescope-packer.nvim", "nvim-dap", "telescope-github.nvim", "telescope-frecency.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-fzf-native.nvim", "nvim-neoclip.lua", "telescope-ghq.nvim" },
...
-- Config for: nvim.lua
time([[Config for nvim.lua]], true)
try_loadstring("\27LJ\2\n(\0\0\3\0\2\0\0056\0\0\0'\2\1\0B\0\2\0027\0\1\0K\0\1\0\tnvim\frequire\0", "config", "nvim.lua")
time([[Config for nvim.lua]], false)
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'nvim-luapad', 'nvim-luaref', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vim-pandoc-syntax', 'nvim-colorizer.lua', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
