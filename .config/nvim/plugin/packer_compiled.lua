...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "lf.nvim", "nvim-scrollbar", "telescope.nvim", "nvim-notify", "vimwiki", "bufferline.nvim" },
  ...
  ["syntax-tree-surfer"] = {
    ...
    keys = { { "n", "<C-M-,>" }, { "n", "<C-M-[>" }, { "n", "<C-M-]>" }, { "n", "<M-S-{>" }, { "n", "<M-S-}>" }, { "n", "(" }, { "n", ")" }, { "n", "vu" }, { "n", "vd" }, { "n", "vU" }, { "n", "vD" }, { "n", "vj" }, { "n", "vk" }, { "n", "vh" }, { "x", "<A-]>" }, { "x", "<A-[>" }, { "x", "<C-A-]>" }, { "x", "<C-A-[>" }, { "x", "<C-k>" }, { "x", "<C-j>" } },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "telescope-rualdi.nvim", "urlview.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "lazygit.nvim", "possession.nvim", "telescope-heading.nvim", "telescope-coc.nvim", "telescope-smart-history.nvim", "project.nvim", "telescope-zoxide", "nvim-dap", "yanky.nvim", "nvim-notify", "todo-comments.nvim", "telescope-frecency.nvim", "telescope-bookmarks.nvim", "telescope-ultisnips.nvim" },
  ...
  ["vim-fugitive"] = {
    ...
    keys = { { "n", "<LocalLeader>gg" }, { "n", "<LocalLeader>ge" }, { "n", "<LocalLeader>gR" }, { "n", "<LocalLeader>gB" }, { "n", "<LocalLeader>gw" }, { "n", "<LocalLeader>gW" }, { "n", "<LocalLeader>gr" }, { "n", "<LocalLeader>gf" }, { "n", "<LocalLeader>gF" }, { "n", "<LocalLeader>gc" }, { "n", "<LocalLeader>gC" }, { "n", "<LocalLeader>gd" }, { "n", "<LocalLeader>gt" }, { "n", "gt" }, { "x", "gt" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
  ...
  ["vim-table-mode"] = {
    ...
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vim-table-mode",
...
require('plugs.markdown').table_mode()
...
pcall(vim.cmd, [[nnoremap <unique><silent> gS <cmd>lua require("packer.load")({'treesj'}, { keys = "gS", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> vk <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vk", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> gt <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "gt", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> vh <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vh", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> f <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "f", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> vj <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vj", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> t <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "t", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> vU <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vU", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> vd <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vd", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ) <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = ")", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> gt <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "gt", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ]v <cmd>lua require("packer.load")({'trouble.nvim'}, { keys = "]v", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <C-M-,> <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "<lt>C-M-,>", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>gd <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "<lt>LocalLeader>gd", prefix = "" }, _G.packer_plugins)<cr>]])
