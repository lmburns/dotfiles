...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "lualine.nvim", "bufferline.nvim", "nvim-scrollbar", "telescope.nvim", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-autotag", "Comment.nvim", "nvim-tree-docs", "nvim-regexplainer", "iswap.nvim", "nvim-treesitter-endwise", "vim-indent-object", "nvim-treesitter-refactor", "playground", "nvim-ts-context-commentstring", "nvim-gps" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "nvim-neoclip.lua", "nvim-dap", "telescope-zoxide", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-bookmarks.nvim", "telescope-rualdi.nvim", "telescope-github.nvim", "telescope-ultisnips.nvim", "telescope-packer.nvim", "telescope-ui-select.nvim", "telescope-ghq.nvim", "telescope-coc.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'lua-dev.nvim', 'luv-vimdocs', 'nvim-luaref', 'nvim-colorizer.lua', 'nvim-luapad'}, { ft = "lua" }, _G.packer_plugins)]]
