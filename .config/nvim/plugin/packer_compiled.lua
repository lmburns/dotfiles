...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "telescope.nvim", "nvim-scrollbar", "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "telescope-ui-select.nvim", "telescope-ghq.nvim", "telescope-frecency.nvim", "nvim-dap", "telescope-packer.nvim", "telescope-hop.nvim", "telescope-coc.nvim", "telescope-ultisnips.nvim", "telescope-file-browser.nvim", "telescope-heading.nvim", "telescope-github.nvim", "telescope-smart-history.nvim", "telescope-bookmarks.nvim", "telescope-zoxide", "telescope-rualdi.nvim", "telescope-fzf-native.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-pandoc-syntax', 'mkdx', 'nvim-colorizer.lua', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nlua.nvim', 'nvim-luaref', 'nvim-luapad', 'nvim-colorizer.lua', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
