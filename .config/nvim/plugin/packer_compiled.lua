...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "bufferline.nvim", "vimwiki", "lualine.nvim", "nvim-scrollbar", "telescope.nvim", "nvim-notify", "lf.nvim" },
  ...
  ["splitjoin.vim"] = {
    config = { "\27LJ\2\na\0\0\2\0\5\0\t6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\1\0'\1\3\0=\1\4\0K\0\1\0\27splitjoin_join_mapping\5\28splitjoin_split_mapping\6g\bvim\0" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/splitjoin.vim",
  ...
  ["telescope.nvim"] = {
    after = { "nvim-dap", "todo-comments.nvim", "lazygit.nvim", "nvim-neoclip.lua", "possession.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-packer.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "project.nvim", "telescope-hop.nvim", "telescope-ghq.nvim", "telescope-ultisnips.nvim", "telescope-file-browser.nvim", "urlview.nvim", "nvim-notify", "telescope-rualdi.nvim", "telescope-heading.nvim" },
...
try_loadstring("\27LJ\2\nµ\1\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\25\0\0\rftdetect\frustpeg\alf\bron\ncmake\bcss\bcpp\6d\tdart\15dockerfile\14gitconfig\ago\ngomod\thtml\bini\tjava\njulia\tjson\tmake\trust\tscss\bzig\bzsh\ash\22polyglot_disabled\6g\bvim\0", "setup", "vim-polyglot")
...
try_loadstring("\27LJ\2\na\0\0\2\0\5\0\t6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\1\0'\1\3\0=\1\4\0K\0\1\0\27splitjoin_join_mapping\5\28splitjoin_split_mapping\6g\bvim\0", "config", "splitjoin.vim")
...
pcall(vim.api.nvim_create_user_command, 'G', function(cmdargs)
          require('packer.load')({'eregex.vim'}, { cmd = 'G', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'eregex.vim'}, {}, _G.packer_plugins)
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'luv-vimdocs', 'nvim-luapad', 'nlua.nvim', 'nvim-luaref'}, { ft = "lua" }, _G.packer_plugins)]]
