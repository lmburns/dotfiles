...
_G.packer_plugins = {
  ...
  ["nvim-comment-frame"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/nvim-comment-frame",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-file-browser.nvim", "nvim-dap", "telescope-hop.nvim", "telescope-ui-select.nvim", "telescope-zoxide", "telescope-frecency.nvim", "telescope-bookmarks.nvim", "telescope-ghq.nvim", "telescope-smart-history.nvim", "telescope-packer.nvim", "telescope-ultisnips.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-coc.nvim", "nvim-neoclip.lua", "telescope-rualdi.nvim" },
...
vim.cmd [[ packadd nvim-comment-frame ]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vim-pandoc-syntax', 'mkdx'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vim-pandoc-syntax', 'nvim-colorizer.lua', 'mkdx'}, { ft = "markdown" }, _G.packer_plugins)]]
