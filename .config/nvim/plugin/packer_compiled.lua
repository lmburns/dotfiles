...
_G.packer_plugins = {
  ...
  ["coc-zsh"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/coc-zsh",
  ...
  kimbox = {
    after = { "bufferline.nvim", "telescope.nvim", "nvim-notify", "lualine.nvim", "vimwiki", "nvim-scrollbar", "lf.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-heading.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-bookmarks.nvim", "telescope-hop.nvim", "nvim-neoclip.lua", "telescope-ghq.nvim", "telescope-file-browser.nvim", "yanky.nvim", "nvim-notify", "urlview.nvim", "overseer.nvim", "telescope-github.nvim", "telescope-ultisnips.nvim", "telescope-smart-history.nvim", "telescope-rualdi.nvim", "telescope-coc.nvim", "todo-comments.nvim", "telescope-fzf-native.nvim", "project.nvim", "nvim-dap" },
  ...
  ["vim-highlightedundo"] = {
    config = { "require('plugs.config').hlundo()" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vim-highlightedundo",
...
-- Config for: vim-highlightedundo
time([[Config for vim-highlightedundo]], true)
require('plugs.config').hlundo()
time([[Config for vim-highlightedundo]], false)
...
vim.cmd [[au FileType zsh ++once lua require("packer.load")({'coc-zsh'}, { ft = "zsh" }, _G.packer_plugins)]]
