...
_G.packer_plugins = {
  ...
  ["coc-ast-grep"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/coc-ast-grep",
  ...
  ["hop.nvim"] = {
    ...
    keys = { { "n", "f" }, { "x", "f" }, { "o", "f" }, { "n", "F" }, { "x", "F" }, { "o", "F" }, { "n", "t" }, { "x", "t" }, { "o", "t" }, { "n", "T" }, { "x", "T" }, { "o", "T" }, { "n", "<Leader><Leader>j" }, { "n", "<Leader><Leader>k" }, { "n", "<Leader><Leader>J" }, { "n", "<Leader><Leader>K" }, { "n", "g(" }, { "n", "g)" }, { "n", "g{" }, { "n", "g}" }, { "n", ";a" }, { "n", "s/" }, { "n", "s?" }, { "o", "," }, { "n", "<C-S-<>" }, { "n", "<C-S-:>" }, { "n", "<Leader>sH" }, { "n", "<Leader>sL" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  kimbox = {
    after = { "bufferline.nvim", "lualine.nvim", "nvim-notify", "nvim-scrollbar", "telescope.nvim", "lf.nvim", "vimwiki" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-dap", "nvim-notify", "nvim-neoclip.lua", "yanky.nvim", "overseer.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-ghq.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "urlview.nvim", "todo-comments.nvim", "project.nvim", "telescope-bookmarks.nvim" },
...
pcall(vim.api.nvim_create_user_command, 'G', function(cmdargs)
          require('packer.load')({'vim-fugitive', 'eregex.vim'}, { cmd = 'G', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-fugitive', 'eregex.vim'}, {}, _G.packer_plugins)
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'lualine.nvim', 'noice.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
