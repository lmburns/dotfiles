...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "telescope.nvim", "nvim-scrollbar", "lualine.nvim", "bufferline.nvim", "vimwiki", "indent-blankline.nvim", "nvim-notify" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "todo-comments.nvim", "telescope-ultisnips.nvim", "lazygit.nvim", "telescope-fzf-native.nvim", "telescope-coc.nvim", "nvim-dap", "telescope-rualdi.nvim", "telescope-github.nvim", "telescope-smart-history.nvim", "possession.nvim", "telescope-zoxide", "nvim-neoclip.lua", "telescope-file-browser.nvim", "telescope-bookmarks.nvim", "telescope-packer.nvim", "urlview.nvim", "telescope-ghq.nvim", "telescope-frecency.nvim", "project.nvim", "telescope-heading.nvim", "telescope-hop.nvim" },
  ...
  ["todo-comments.nvim"] = {
    ...
    url = "https://github.com/eriedaberrie/todo-comments.nvim",
    wants = { "plenary.nvim" }
  },
  ["toggleterm.nvim"] = {
    commands = { "T", "TR", "TP", "VT" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'nvim-luapad', 'nlua.nvim', 'lua-dev.nvim', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vimwiki'}, { ft = "markdown" }, _G.packer_plugins)]]
