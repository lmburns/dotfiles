...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim", "telescope.nvim", "nvim-notify" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "urlview.nvim", "todo-comments.nvim", "possession.nvim", "telescope-packer.nvim", "telescope-rualdi.nvim", "nvim-dap", "project.nvim", "telescope-smart-history.nvim", "telescope-ghq.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "lazygit.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-heading.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "telescope-bookmarks.nvim", "telescope-coc.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'vim-markdown', 'vim-table-mode'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'nvim-colorizer.lua', 'vim-markdown', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'nvim-luaref', 'nvim-colorizer.lua', 'nlua.nvim', 'luv-vimdocs', 'nvim-luapad'}, { ft = "lua" }, _G.packer_plugins)]]
