...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "bufferline.nvim", "lualine.nvim", "lf.nvim", "vimwiki", "nvim-scrollbar", "telescope.nvim", "nvim-notify" },
  ...
  ["possession.nvim"] = {
    ...
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/possession.nvim",
  ...
  ["substitute.nvim"] = {
    ...
    keys = { { "n", "s" }, { "n", "ss" }, { "n", "se" }, { "n", "sr" }, { "n", "sa" }, { "n", "<Leader>sr" }, { "n", "sS" }, { "n", "sx" }, { "n", "sxx" }, { "n", "sxc" }, { "x", "s" }, { "x", "X" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ultisnips.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-frecency.nvim", "lazygit.nvim", "telescope-heading.nvim", "nvim-neoclip.lua", "telescope-ghq.nvim", "telescope-packer.nvim", "project.nvim", "telescope-bookmarks.nvim", "telescope-file-browser.nvim", "telescope-coc.nvim", "todo-comments.nvim", "nvim-dap", "telescope-zoxide", "telescope-rualdi.nvim", "urlview.nvim", "telescope-github.nvim" },
