...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-scrollbar", "telescope.nvim", "lualine.nvim", "bufferline.nvim", "vimwiki" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nlua.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/nlua.nvim",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-github.nvim", "telescope-ultisnips.nvim", "telescope-packer.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "nvim-dap", "telescope-ui-select.nvim", "telescope-coc.nvim", "nvim-neoclip.lua", "telescope-smart-history.nvim", "telescope-hop.nvim", "telescope-file-browser.nvim", "telescope-ghq.nvim", "telescope-bookmarks.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
