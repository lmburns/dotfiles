...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "telescope.nvim", "lualine.nvim", "nvim-scrollbar", "bufferline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-packer.nvim", "nvim-neoclip.lua", "telescope-ghq.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ultisnips.nvim", "telescope-smart-history.nvim" },
  ...
  ["vim-sneak"] = {
    config = { "require('plugs.config').sneak()" },
    keys = { { "n", "f" }, { "n", "F" } },
    load_after = {
      ["vim-surround"] = true
    },
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/vim-sneak",
...
pcall(vim.cmd, [[nnoremap <unique><silent> f <cmd>lua require("packer.load")({'vim-sneak'}, { keys = "f", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vim-pandoc-syntax', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'nvim-colorizer.lua', 'mkdx', 'vim-pandoc-syntax', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
