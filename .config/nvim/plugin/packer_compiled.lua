...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    after = { "coc-wxy", "coc-graphql", "coc-code-action-menu", "coc-fzf", "coc-kvs" },
    loaded = true,
    needs_bufread = false,
  ...
  kimbox = {
    after = { "nvim-scrollbar", "telescope.nvim", "lf.nvim", "lualine.nvim", "vimwiki", "nvim-notify", "bufferline.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ghq.nvim", "telescope-fzf-native.nvim", "urlview.nvim", "telescope-rualdi.nvim", "telescope-coc.nvim", "telescope-bookmarks.nvim", "telescope-hop.nvim", "yanky.nvim", "telescope-ultisnips.nvim", "nvim-neoclip.lua", "nvim-dap", "telescope-heading.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-zoxide", "todo-comments.nvim", "overseer.nvim", "project.nvim", "telescope-smart-history.nvim", "telescope-file-browser.nvim", "nvim-notify" },
