...
_G.packer_plugins = {
  ...
  UnconditionalPaste = {
    keys = { { "n", "gcp" }, { "n", "gcP" }, { "n", "glp" }, { "n", "glP" }, { "n", "gbp" }, { "n", "gbP" }, { "n", "ghp" }, { "n", "ghP" }, { "n", "g#p" }, { "n", "g#P" }, { "n", "g2p" }, { "n", "g2P" }, { "n", "g>p" }, { "n", "g>P" }, { "n", "g[p" }, { "n", "g[P" }, { "n", "gsp" }, { "n", "gsP" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["hop.nvim"] = {
    ...
    keys = { { "n", "f" }, { "x", "f" }, { "o", "f" }, { "n", "F" }, { "x", "F" }, { "o", "F" }, { "n", "t" }, { "x", "t" }, { "o", "t" }, { "n", "T" }, { "x", "T" }, { "o", "T" }, { "n", "<Leader><Leader>h" }, { "n", "<Leader><Leader>j" }, { "n", "<Leader><Leader>k" }, { "n", "<Leader><Leader>l" }, { "n", "g(" }, { "n", "g)" }, { "n", "g{" }, { "n", "g}" }, { "n", ";a" }, { "n", "<C-S-<>" }, { "n", "<C-S-:>" }, { "n", "[n" }, { "n", "]n" }, { "n", "vx" }, { "o", "," }, { "x", "," } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["id3.nvim"] = {
    config = { "\27LJ\2\nX\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\14flac_tool\rmetaflac\rmp3_tool\bid3\nsetup\bid3\frequire\0" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/id3.nvim",
    url = "https://gitlab.com/itaranto/id3.nvim"
  },
  ["impatient.nvim"] = {
    loaded = true,
  ...
  ["iswap.nvim"] = {
    ...
    keys = { { "n", "vs" }, { "n", "sv" }, { "n", "so" }, { "n", "sp" }, { "n", "s," }, { "n", "s." } },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  kimbox = {
    after = { "nvim-scrollbar", "nvim-notify", "lf.nvim", "vimwiki", "lualine.nvim", "bufferline.nvim", "telescope.nvim" },
  ...
  ["lazygit.nvim"] = {
    config = { "require('plugs.git').lazygit()" },
    load_after = {},
    loaded = true,
    needs_bufread = true,
  ...
  mkdx = {
    ...
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/mkdx",
  ...
  ["resession.nvim"] = {
    config = { "require('plugs.resession')" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/resession.nvim",
  ...
  ["ssr.nvim"] = {
    config = { "require('plugs.treesitter').setup_ssr()" },
    keys = { { "n", "<Leader>s;" } },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/ssr.nvim",
  ...
  ["syntax-tree-surfer"] = {
    ...
    keys = { { "n", "<C-M-,>" }, { "n", "<C-M-[>" }, { "n", "<C-M-]>" }, { "n", "<M-S-{>" }, { "n", "<M-S-}>" }, { "n", "(" }, { "n", ")" }, { "n", "vu" }, { "n", "vd" }, { "n", "vU" }, { "n", "vD" }, { "n", "vn" }, { "n", "vm" }, { "n", "v;" }, { "x", "<A-]>" }, { "x", "<A-[>" }, { "x", "<C-A-]>" }, { "x", "<C-A-[>" }, { "x", "<C-k>" }, { "x", "<C-j>" } },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "nvim-notify", "urlview.nvim", "yanky.nvim", "todo-comments.nvim", "telescope-coc.nvim", "telescope-ghq.nvim", "nvim-neoclip.lua", "telescope-rualdi.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "project.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "resession.nvim", "lazygit.nvim", "telescope-zoxide", "telescope-github.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "nvim-dap", "telescope-file-browser.nvim", "telescope-bookmarks.nvim", "overseer.nvim" },
  ...
  ["vim-table-mode"] = {
    ...
    keys = { { "n", "<LocalLeader>H" }, { "n", "<LocalLeader>L" }, { "n", "<LocalLeader>K" }, { "n", "<LocalLeader>J" }, { "n", "<Leader>tm" }, { "n", "<Leader>tS" }, { "n", "<Leader>tt" }, { "n", "<Leader>tr" }, { "n", "<Leader>t?" }, { "n", "<Leader>tdd" }, { "n", "<Leader>tdc" }, { "n", "<Leader>tiC" }, { "n", "<Leader>tic" }, { "n", "<Leader>tfa" }, { "n", "<Leader>tfe" }, { "n", "<Leader>ts" }, { "x", "<Leader>ts" }, { "x", "<Leader>tt" }, { "x", "<Leader>T" }, { "x", "ax" }, { "x", "ix" }, { "o", "ax" }, { "o", "ix" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd("source ~/.config/nvim/vimscript/plugins/mkdx.vim")
time([[Config for mkdx]], false)
-- Config for: id3.nvim
time([[Config for id3.nvim]], true)
try_loadstring("\27LJ\2\nX\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\14flac_tool\rmetaflac\rmp3_tool\bid3\nsetup\bid3\frequire\0", "config", "id3.nvim")
time([[Config for id3.nvim]], false)
...
pcall(vim.api.nvim_create_user_command, 'G', function(cmdargs)
          require('packer.load')({'eregex.vim', 'vim-fugitive'}, { cmd = 'G', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'eregex.vim', 'vim-fugitive'}, {}, _G.packer_plugins)
...
pcall(vim.cmd, [[nnoremap <unique><silent> vx <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "vx", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> g2p <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g2p", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>K <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>LocalLeader>K", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> g#p <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g#p", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> g2P <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g2P", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ;a <cmd>lua require("packer.load")({'hop.nvim'}, { keys = ";a", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tdd <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tdd", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[onoremap <unique><silent> f <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "f", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <M-S-{> <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "<lt>M-S-{>", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[onoremap <unique><silent> ix <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "ix", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> <Leader>tt <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tt", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> g[P <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g[P", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> g>p <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g>p", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tdc <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tdc", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>s; <cmd>lua require("packer.load")({'ssr.nvim'}, { keys = "<lt>Leader>s;", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tiC <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tiC", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>H <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>LocalLeader>H", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tS <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tS", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> [n <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "[n", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> ax <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "ax", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> sp <cmd>lua require("packer.load")({'iswap.nvim'}, { keys = "sp", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>gl <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "<lt>LocalLeader>gl", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> <A-]> <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "<lt>A-]>", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> vD <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vD", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>ts <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>ts", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> [V <cmd>lua require("packer.load")({'trouble.nvim'}, { keys = "[V", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> , <cmd>lua require("packer.load")({'hop.nvim'}, { keys = ",", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <C-M-,> <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "<lt>C-M-,>", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> s, <cmd>lua require("packer.load")({'iswap.nvim'}, { keys = "s,", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>J <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>LocalLeader>J", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> <C-A-[> <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "<lt>C-A-[>", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> gcp <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gcp", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>gW <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "<lt>LocalLeader>gW", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> <Leader>ts <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>ts", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[onoremap <unique><silent> ax <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "ax", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tfe <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tfe", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> vu <cmd>lua require("packer.load")({'syntax-tree-surfer'}, { keys = "vu", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>/ <cmd>lua require("packer.load")({'vim-visual-multi'}, { keys = "<lt>Leader>/", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> <Leader>T <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>T", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> ix <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "ix", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> gsP <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gsP", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> ;a <cmd>lua require("packer.load")({'vim-visual-multi'}, { keys = ";a", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>dF <cmd>lua require("packer.load")({'neogen'}, { keys = "<lt>Leader>dF", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tfa <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tfa", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tr <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tr", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> t <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "t", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>xr <cmd>lua require("packer.load")({'trouble.nvim'}, { keys = "<lt>Leader>xr", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> g} <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "g}", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>t? <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>t?", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tic <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tic", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> g) <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "g)", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>x; <cmd>lua require("packer.load")({'trouble.nvim'}, { keys = "<lt>Leader>x;", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>L <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>LocalLeader>L", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> t <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "t", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tm <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tm", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <LocalLeader>gh <cmd>lua require("packer.load")({'vim-fugitive'}, { keys = "<lt>LocalLeader>gh", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>tt <cmd>lua require("packer.load")({'vim-table-mode'}, { keys = "<lt>Leader>tt", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vimwiki'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vimwiki'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType atex ++once lua require("packer.load")({'vimtex'}, { ft = "atex" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'nvim-ts-autotag'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-ts-autotag', 'template-string.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'nvim-ts-autotag', 'template-string.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-ts-autotag', 'template-string.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'comment-box.nvim', 'nvim-scrollbar'}, { event = "BufEnter *" }, _G.packer_plugins)]]
