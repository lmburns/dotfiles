...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim", "nvim-scrollbar", "vimwiki", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-rualdi.nvim", "nvim-dap", "telescope-smart-history.nvim", "telescope-bookmarks.nvim", "telescope-ultisnips.nvim", "urlview.nvim", "telescope-ghq.nvim", "telescope-fzf-native.nvim", "telescope-ui-select.nvim", "telescope-heading.nvim", "telescope-zoxide", "telescope-github.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-packer.nvim", "telescope-hop.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'luv-vimdocs', 'lua-dev.nvim', 'nvim-luaref', 'nvim-luapad', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vim-pandoc-syntax', 'vim-markdown', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
