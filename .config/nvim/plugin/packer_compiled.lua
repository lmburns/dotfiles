...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    after = { "coc-code-action-menu", "coc-fzf", "coc-wxy", "coc-kvs" },
    loaded = true,
    only_config = true
  },
  ["comment-box.nvim"] = {
  ...
  kimbox = {
    after = { "lualine.nvim", "bufferline.nvim", "vimwiki", "nvim-notify", "indent-blankline.nvim", "telescope.nvim", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "lazygit.nvim", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "urlview.nvim", "project.nvim", "telescope-coc.nvim", "todo-comments.nvim", "nvim-dap", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-packer.nvim", "telescope-github.nvim", "telescope-bookmarks.nvim", "telescope-ultisnips.nvim", "telescope-heading.nvim", "telescope-hop.nvim" },
...
pcall(vim.cmd, [[noremap <unique><silent> gxx <cmd>lua require("packer.load")({'toggleterm.nvim'}, { keys = "gxx", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> gap <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gap", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> g]P <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "g]P", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[noremap <unique><silent> gx <cmd>lua require("packer.load")({'toggleterm.nvim'}, { keys = "gx", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> gsp <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gsp", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[xnoremap <unique><silent> <Leader>gL <cmd>lua require("packer.load")({'vim-gh-line'}, { keys = "<lt>Leader>gL", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <Leader>gf <cmd>lua require("packer.load")({'vim-flog'}, { keys = "<lt>Leader>gf", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'mkdx', 'vim-markdown', 'vim-table-mode'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdx', 'vim-markdown', 'vim-table-mode', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'nvim-luaref', 'lua-dev.nvim', 'luv-vimdocs', 'nlua.nvim', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
