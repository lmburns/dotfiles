...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "nvim-scrollbar", "telescope.nvim", "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ultisnips.nvim", "telescope-ui-select.nvim", "nvim-dap", "nvim-neoclip.lua", "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-hop.nvim", "telescope-ghq.nvim", "telescope-smart-history.nvim", "telescope-coc.nvim", "telescope-packer.nvim", "telescope-rualdi.nvim", "telescope-frecency.nvim", "telescope-file-browser.nvim", "telescope-bookmarks.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'nvim-colorizer.lua', 'nlua.nvim', 'nvim-luapad'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'rust.vim'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-pandoc-syntax', 'nvim-colorizer.lua', 'vim-markdown', 'mkdx'}, { ft = "markdown" }, _G.packer_plugins)]]
