...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ghq.nvim", "telescope-github.nvim", "nvim-neoclip.lua", "telescope-packer.nvim", "telescope-smart-history.nvim", "telescope-ui-select.nvim", "telescope-ultisnips.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-fzf-native.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vim-pandoc-syntax', 'mkdx', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-table-mode', 'vim-pandoc-syntax', 'mkdx', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
