...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "indent-blankline.nvim", "nvim-notify", "vimwiki", "nvim-scrollbar", "lualine.nvim", "telescope.nvim", "bufferline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "possession.nvim", "project.nvim", "lazygit.nvim", "todo-comments.nvim", "nvim-dap", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-packer.nvim", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "urlview.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vimwiki'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vimwiki', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'lua-dev.nvim', 'luv-vimdocs', 'nlua.nvim', 'nvim-luapad', 'nvim-luaref', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
