...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "bufferline.nvim", "nvim-notify", "indent-blankline.nvim", "lf.nvim", "lualine.nvim", "telescope.nvim", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "possession.nvim", "project.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "urlview.nvim", "nvim-dap", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "lazygit.nvim", "telescope-zoxide", "nvim-neoclip.lua", "todo-comments.nvim", "telescope-packer.nvim" },
  ...
  ["vim-fugitive"] = {
    ...
    keys = { { "n", "<LocalLeader>gg" }, { "n", "<LocalLeader>ge" }, { "n", "<LocalLeader>gR" }, { "n", "<LocalLeader>gB" }, { "n", "<LocalLeader>gw" }, { "n", "<LocalLeader>gr" }, { "n", "<LocalLeader>gf" }, { "n", "<LocalLeader>gF" }, { "n", "<Leader>gC" }, { "n", "<Leader>gd" }, { "n", "<Leader>gt" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'lua-dev.nvim', 'nvim-luapad', 'nvim-luaref', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
