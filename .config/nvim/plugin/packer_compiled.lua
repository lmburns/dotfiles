...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-scrollbar", "lualine.nvim", "bufferline.nvim", "vimwiki", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-hop.nvim", "telescope-packer.nvim", "nvim-dap", "telescope-bookmarks.nvim", "telescope-ui-select.nvim", "telescope-coc.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "nvim-neoclip.lua", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-file-browser.nvim", "telescope-ultisnips.nvim", "telescope-ghq.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-table-mode', 'mkdx', 'vim-markdown', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vim-markdown', 'vim-pandoc-syntax'}, { ft = "vimwiki" }, _G.packer_plugins)]]
