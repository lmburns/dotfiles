...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "telescope.nvim", "bufferline.nvim", "lf.nvim", "nvim-scrollbar", "lualine.nvim", "vimwiki", "nvim-notify" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-rualdi.nvim", "todo-comments.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-frecency.nvim", "telescope-packer.nvim", "nvim-neoclip.lua", "telescope-coc.nvim", "possession.nvim", "project.nvim", "lazygit.nvim", "telescope-heading.nvim", "telescope-bookmarks.nvim", "nvim-dap", "telescope-fzf-native.nvim", "urlview.nvim", "nvim-notify", "telescope-ghq.nvim", "telescope-ultisnips.nvim", "telescope-file-browser.nvim", "telescope-hop.nvim", "telescope-github.nvim" },
  ...
  vve = {
    config = { "require('plugs.config').vve()" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vve",
    url = "https://github.com/qtc-de/vve"
  },
  ["which-key.nvim"] = {
...
try_loadstring("\27LJ\2\n—\1\0\0\2\0\5\0\t6\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0005\1\4\0=\1\3\0K\0\1\0\1\25\0\0\rftdetect\frustpeg\alf\bron\ncmake\bcss\bcpp\6d\tdart\15dockerfile\14gitconfig\ago\ngomod\thtml\bini\tjava\njulia\tjson\tmake\trust\tscss\bzig\bzsh\ash\22polyglot_disabled\16no_csv_maps\6g\bvim\0", "setup", "vim-polyglot")
...
require('plugs.ecma').template_string()
...
require('plugs.comment').comment_box()
...
-- Config for: vve
time([[Config for vve]], true)
require('plugs.config').vve()
time([[Config for vve]], false)
-- Config for: id3.nvim
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'nlua.nvim', 'nvim-luaref', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
