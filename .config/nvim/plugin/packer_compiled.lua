...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "bufferline.nvim", "nvim-scrollbar", "lualine.nvim", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "nvim-neoclip.lua", "telescope-github.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-packer.nvim", "telescope-ghq.nvim" },
  ...
  ["vim-sandwich"] = {
    config = { "\27LJ\2\nv\0\0\6\0\6\0\v6\0\0\0009\0\1\0'\2\2\0B\0\2\0026\1\3\0'\3\4\0\18\4\0\0'\5\5\0&\3\5\3B\1\2\1K\0\1\0)/vimscript/plugins/vim-sandwhich.vim\fsource \bcmd\vconfig\fstdpath\afn\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\nv\0\0\6\0\6\0\v6\0\0\0009\0\1\0'\2\2\0B\0\2\0026\1\3\0'\3\4\0\18\4\0\0'\5\5\0&\3\5\3B\1\2\1K\0\1\0)/vimscript/plugins/vim-sandwhich.vim\fsource \bcmd\vconfig\fstdpath\afn\0", "config", "vim-sandwich")
...
pcall(vim.cmd, [[xnoremap <unique><silent> gS <cmd>lua require("packer.load")({'vim-surround'}, { keys = "gS", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> cS <cmd>lua require("packer.load")({'vim-surround'}, { keys = "cS", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[xnoremap <unique><silent> S <cmd>lua require("packer.load")({'vim-surround'}, { keys = "S", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> cs <cmd>lua require("packer.load")({'vim-surround'}, { keys = "cs", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> yss <cmd>lua require("packer.load")({'vim-surround'}, { keys = "yss", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> yS <cmd>lua require("packer.load")({'vim-surround'}, { keys = "yS", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ys <cmd>lua require("packer.load")({'vim-surround'}, { keys = "ys", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ds <cmd>lua require("packer.load")({'vim-surround'}, { keys = "ds", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> ygs <cmd>lua require("packer.load")({'vim-surround'}, { keys = "ygs", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-markdown', 'mkdx', 'vim-table-mode', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-markdown', 'mkdx', 'vim-table-mode', 'vim-pandoc-syntax'}, { ft = "vimwiki" }, _G.packer_plugins)]]
