...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-scrollbar", "vimwiki", "telescope.nvim", "lf.nvim", "lualine.nvim", "nvim-notify", "bufferline.nvim", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "telescope-file-browser.nvim", "telescope-coc.nvim", "telescope-heading.nvim", "possession.nvim", "telescope-packer.nvim", "telescope-ghq.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "lazygit.nvim", "telescope-hop.nvim", "nvim-neoclip.lua", "telescope-bookmarks.nvim", "telescope-ultisnips.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "nvim-dap", "telescope-rualdi.nvim", "project.nvim", "todo-comments.nvim" },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Lf lua require("packer.load")({'lf.nvim'}, { cmd = "Lf", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[nnoremap <unique><silent> <A-o> <cmd>lua require("packer.load")({'lf.nvim'}, { keys = "<lt>A-o>", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'nlua.nvim', 'lua-dev.nvim', 'luv-vimdocs', 'nvim-luaref'}, { ft = "lua" }, _G.packer_plugins)]]
