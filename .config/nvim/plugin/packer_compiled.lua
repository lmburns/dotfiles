...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    after = { "coc-fzf", "coc-kvs", "coc-code-action-menu" },
  ...
  ["id3.nvim"] = {
    config = { "\27LJ\2\nX\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\rmp3_tool\bid3\14flac_tool\rmetaflac\nsetup\bid3\frequire\0" },
    loaded = true,
  ...
  kimbox = {
    after = { "nvim-scrollbar", "vimwiki", "nvim-notify", "lf.nvim", "lualine.nvim", "bufferline.nvim", "telescope.nvim" },
  ...
  ["syntax-tree-surfer"] = {
    ...
    keys = { { "n", "<C-M-,>" }, { "n", "<C-M-[>" }, { "n", "<C-M-]>" }, { "n", "<M-S-{>" }, { "n", "<M-S-}>" }, { "n", "(" }, { "n", ")" }, { "n", "vu" }, { "n", "vd" }, { "n", "su" }, { "n", "sd" }, { "n", "vU" }, { "n", "vD" }, { "n", "vn" }, { "n", "vm" }, { "n", "v;" }, { "x", "<A-]>" }, { "x", "<A-[>" }, { "x", "<C-A-]>" }, { "x", "<C-A-[>" }, { "x", "<C-k>" }, { "x", "<C-j>" } },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "overseer.nvim", "yanky.nvim", "urlview.nvim", "nvim-notify", "nvim-dap", "telescope-hop.nvim", "todo-comments.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-heading.nvim", "nvim-neoclip.lua", "lazygit.nvim", "telescope-github.nvim", "telescope-zoxide", "telescope-ghq.nvim", "telescope-rualdi.nvim", "project.nvim", "telescope-bookmarks.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'vim-table-mode'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
