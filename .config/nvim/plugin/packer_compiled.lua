...
_G.packer_plugins = {
  ...
  UnconditionalPaste = {
    keys = { { "n", "gcp" }, { "n", "gcP" }, { "n", "glp" }, { "n", "glP" }, { "n", "gbp" }, { "n", "gbP" }, { "n", "gap" }, { "n", "g]p" }, { "n", "g]P" }, { "n", "g[p" }, { "n", "g[P" }, { "n", "gsp" }, { "n", "gsP" }, { "n", "g,p" }, { "n", "g,P" }, { "n", "g,'p" }, { "n", "g,'P" }, { "n", "gqp" }, { "n", "gqP" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["coc.nvim"] = {
    after = { "coc-kvs", "coc-wxy", "coc-code-action-menu", "coc-fzf" },
    loaded = true,
    only_config = true
  },
  ["comment-box.nvim"] = {
  ...
  kimbox = {
    after = { "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim", "nvim-notify", "nvim-scrollbar", "telescope.nvim", "vimwiki" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope-packer.nvim"] = {
    config = { "\27LJ\2\nÄ\1\0\1\4\0\n\0\0256\1\0\0'\3\1\0B\1\2\0029\1\2\1'\3\3\0B\1\2\0016\1\4\0009\1\5\1'\3\3\0B\1\2\0016\1\0\0'\3\6\0B\1\2\0029\1\a\1'\3\b\0B\1\2\0016\1\0\0'\3\6\0B\1\2\0029\1\t\0019\1\b\0019\1\b\1\18\3\0\0B\1\2\1K\0\1\0\15extensions\vpacker\19load_extension\14telescope\fpackadd\aex\16packer.nvim\vloader\fplugins\frequireA\1\0\3\0\4\0\0066\0\0\0'\2\1\0B\0\2\0023\1\3\0=\1\2\0K\0\1\0\0\vpacker\22telescope.builtin\frequire\0" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "todo-comments.nvim", "telescope-file-browser.nvim", "telescope-ghq.nvim", "project.nvim", "lazygit.nvim", "telescope-packer.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-ultisnips.nvim", "telescope-rualdi.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-smart-history.nvim", "nvim-dap", "telescope-coc.nvim", "telescope-fzf-native.nvim", "telescope-zoxide", "telescope-bookmarks.nvim" },
  ...
  ["vscode.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vscode.nvim",
...
try_loadstring("\27LJ\2\n5\0\0\2\0\3\0\0056\0\0\0009\0\1\0009\0\2\0B\0\1\1K\0\1\0\23vm#plugs#permanent\afn\bvimP\1\0\3\0\5\1\t6\0\0\0009\0\1\0\t\0\0\0X\0\4€6\0\2\0009\0\3\0003\2\4\0B\0\2\1K\0\1\0\0\rschedule\bvim\24loaded_visual_multi\6g\2\0", "setup", "packer.nvim")
...
try_loadstring("\27LJ\2\nÄ\1\0\1\4\0\n\0\0256\1\0\0'\3\1\0B\1\2\0029\1\2\1'\3\3\0B\1\2\0016\1\4\0009\1\5\1'\3\3\0B\1\2\0016\1\0\0'\3\6\0B\1\2\0029\1\a\1'\3\b\0B\1\2\0016\1\0\0'\3\6\0B\1\2\0029\1\t\0019\1\b\0019\1\b\1\18\3\0\0B\1\2\1K\0\1\0\15extensions\vpacker\19load_extension\14telescope\fpackadd\aex\16packer.nvim\vloader\fplugins\frequireA\1\0\3\0\4\0\0066\0\0\0'\2\1\0B\0\2\0023\1\3\0=\1\2\0K\0\1\0\0\vpacker\22telescope.builtin\frequire\0", "config", "telescope-packer.nvim")
...
vim.cmd [[nnoremap <silent> gqP <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gqP", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[nnoremap <silent> gqp <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gqp", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[nnoremap <silent> gap <cmd>lua require("packer.load")({'UnconditionalPaste'}, { keys = "gap", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'nvim-colorizer.lua', 'vim-table-mode', 'mkdx'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-markdown', 'vim-table-mode', 'mkdx'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'luv-vimdocs', 'nlua.nvim', 'nvim-colorizer.lua', 'nvim-luapad', 'nvim-luaref', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
