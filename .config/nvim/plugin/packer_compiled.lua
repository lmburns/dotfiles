...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "lf.nvim", "telescope.nvim", "mkdx", "lualine.nvim", "bufferline.nvim", "nvim-scrollbar", "nvim-notify" },
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "todo-comments.nvim", "telescope-hop.nvim", "telescope-bookmarks.nvim", "telescope-file-browser.nvim", "project.nvim", "telescope-zoxide", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "nvim-neoclip.lua", "telescope-rualdi.nvim", "telescope-heading.nvim", "telescope-ultisnips.nvim", "telescope-smart-history.nvim", "nvim-notify", "telescope-ghq.nvim", "telescope-coc.nvim" },
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'incline.nvim', 'virtcolumn.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
