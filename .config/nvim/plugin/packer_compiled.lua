...
_G.packer_plugins = {
  ...
  UnconditionalPaste = {
    keys = { { "n", "gcp" }, { "n", "gcP" }, { "n", "glp" }, { "n", "glP" }, { "n", "gbp" }, { "n", "gbP" }, { "n", "ghp" }, { "n", "ghP" }, { "n", "g#p" }, { "n", "g#P" }, { "n", "g>p" }, { "n", "g>P" }, { "n", "g[p" }, { "n", "g[P" }, { "n", "gsp" }, { "n", "gsP" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  kimbox = {
    after = { "nvim-scrollbar", "telescope.nvim", "vimwiki", "nvim-notify", "bufferline.nvim", "lf.nvim", "lualine.nvim" },
  ...
  ["nvim-various-textobjs"] = {
    config = { "require('plugs.config').various_textobjs()" },
    loaded = true,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-rualdi.nvim", "urlview.nvim", "nvim-notify", "lazygit.nvim", "project.nvim", "nvim-neoclip.lua", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-github.nvim", "telescope-smart-history.nvim", "possession.nvim", "telescope-ghq.nvim", "telescope-hop.nvim", "telescope-bookmarks.nvim", "todo-comments.nvim", "nvim-dap", "telescope-coc.nvim", "telescope-ultisnips.nvim", "telescope-fzf-native.nvim", "telescope-heading.nvim", "telescope-zoxide", "telescope-packer.nvim" },
...
require('plugs.config').various_textobjs()
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'vimwiki'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-markdown', 'vimwiki'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'nlua.nvim', 'luv-vimdocs', 'nvim-luapad'}, { ft = "lua" }, _G.packer_plugins)]]
