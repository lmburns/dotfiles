...
_G.packer_plugins = {
  ...
  ["cybu.nvim"] = {
    config = { "require('plugs.cybu')" },
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/cybu.nvim",
  ...
  ["drop.nvim"] = {
    config = { "\27LJ\2\n•\1\0\0\5\0\v\0\0216\0\0\0009\0\1\0006\2\2\0009\2\3\2B\2\1\0A\0\0\0015\0\4\0006\1\0\0009\1\5\1)\3\1\0)\4\2\0B\1\3\0028\0\1\0006\1\6\0'\3\a\0B\1\2\0029\1\b\0015\3\t\0=\0\n\3B\1\2\1K\0\1\0\ntheme\1\0\0\nsetup\tdrop\frequire\vrandom\1\3\0\0\nstars\tsnow\ttime\aos\15randomseed\tmath\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/drop.nvim",
  ...
  kimbox = {
    after = { "lualine.nvim", "vimwiki", "nvim-scrollbar", "lf.nvim", "nvim-notify", "telescope.nvim", "bufferline.nvim", "indent-blankline.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-bookmarks.nvim", "telescope-fzf-native.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "lazygit.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-ultisnips.nvim", "telescope-file-browser.nvim", "nvim-neoclip.lua", "telescope-packer.nvim", "nvim-dap", "telescope-rualdi.nvim", "todo-comments.nvim", "telescope-frecency.nvim", "project.nvim", "telescope-coc.nvim", "urlview.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'mkdx', 'vim-table-mode', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'mkdx', 'vim-table-mode', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luapad', 'nvim-luaref', 'nlua.nvim', 'luv-vimdocs'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'drop.nvim', 'telescope-packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
