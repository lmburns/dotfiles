...
_G.packer_plugins = {
  ...
  ["colortils.nvim"] = {
    commands = { "Colortils" },
    config = { "require('plugs.config').colortils()" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  kimbox = {
    after = { "nvim-scrollbar", "lualine.nvim", "bufferline.nvim", "telescope.nvim", "vimwiki", "nvim-notify", "indent-blankline.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "todo-comments.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-ghq.nvim", "telescope-heading.nvim", "possession.nvim", "telescope-github.nvim", "telescope-bookmarks.nvim", "telescope-hop.nvim", "lazygit.nvim", "telescope-packer.nvim", "nvim-dap", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "nvim-neoclip.lua", "telescope-fzf-native.nvim", "project.nvim", "telescope-zoxide" },
...
try_loadstring("\27LJ\2\n¥\1\0\0\2\0\4\0\0056\0\0\0009\0\1\0005\1\3\0=\1\2\0K\0\1\0\1\24\0\0\rftdetect\rmarkdown\frustpeg\alf\bron\ncmake\bcss\bcpp\6d\tdart\15dockerfile\ago\ngomod\thtml\tjava\tmake\vpython\nquery\truby\trust\tscss\bvim\bzig\22polyglot_disabled\6g\bvim\0", "setup", "vim-polyglot")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'vimwiki', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'luv-vimdocs', 'lua-dev.nvim', 'nvim-luaref', 'nvim-luapad'}, { ft = "lua" }, _G.packer_plugins)]]
