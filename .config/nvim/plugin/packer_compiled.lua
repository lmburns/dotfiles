...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    after = { "coc-graphql", "coc-wxy", "coc-fzf", "coc-code-action-menu", "coc-kvs" },
    loaded = true,
    needs_bufread = false,
  ...
  kimbox = {
    after = { "telescope.nvim", "nvim-notify", "nvim-scrollbar", "lualine.nvim", "vimwiki", "bufferline.nvim", "lf.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "todo-comments.nvim", "telescope-file-browser.nvim", "telescope-ultisnips.nvim", "telescope-smart-history.nvim", "telescope-zoxide", "telescope-coc.nvim", "project.nvim", "telescope-bookmarks.nvim", "telescope-heading.nvim", "overseer.nvim", "nvim-notify", "urlview.nvim", "telescope-ghq.nvim", "telescope-rualdi.nvim", "nvim-neoclip.lua", "telescope-hop.nvim", "yanky.nvim", "nvim-dap", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-github.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'mkdx', 'vim-table-mode'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'mkdx', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
