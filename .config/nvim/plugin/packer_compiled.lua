...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    commands = { "Copilot" },
    config = { "require('plugs.config').copilot()" },
    keys = { { "", "n" }, { "", "<Leader>ce" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/copilot.vim",
  ...
  kimbox = {
    after = { "lualine.nvim", "lf.nvim", "indent-blankline.nvim", "bufferline.nvim", "nvim-scrollbar", "telescope.nvim", "vimwiki", "nvim-notify" },
  ...
  ["overseer.nvim"] = {
    commands = { "OverseerOpen", "OverseerClose", "OverseerToggle", "OverseerSaveBundle", "OverseerLoadBundle", "OverseerDeleteBundle", "OverseerRunCmd", "OverseerRun", "OverseerBuild", "OverseerQuickAction", "OverseerTaskAction" },
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "todo-comments.nvim", "nvim-neoclip.lua", "telescope-github.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-packer.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "project.nvim", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "lazygit.nvim", "telescope-ghq.nvim", "nvim-dap", "telescope-rualdi.nvim" },
...
pcall(vim.cmd, [[noremap <unique><silent> <Leader>ce <cmd>lua require("packer.load")({'copilot.vim'}, { keys = "<lt>Leader>ce", prefix = "" }, _G.packer_plugins)<cr>]])
...
pcall(vim.cmd, [[noremap <unique><silent> n <cmd>lua require("packer.load")({'copilot.vim'}, { keys = "n", prefix = "" }, _G.packer_plugins)<cr>]])
pcall(vim.cmd, [[nnoremap <unique><silent> ? <cmd>lua require("packer.load")({'nvim-hlslens'}, { keys = "?", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vimwiki', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vimwiki', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
