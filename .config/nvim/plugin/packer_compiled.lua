...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lf.nvim", "vimwiki", "telescope.nvim", "nvim-scrollbar", "bufferline.nvim", "nvim-notify", "lualine.nvim" },
  ...
  ["linediff.vim"] = {
    ...
    keys = { { "n", "<Leader>ld" }, { "x", "<Leader>ld" }, { "x", "D" }, { "n", "<Leader>lD" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-python", "one-small-step-for-vimkind", "nvim-dap-virtual-text", "telescope-dap.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-rualdi.nvim", "telescope-smart-history.nvim", "nvim-notify", "telescope-ultisnips.nvim", "telescope-zoxide", "urlview.nvim", "todo-comments.nvim", "nvim-neoclip.lua", "project.nvim", "telescope-file-browser.nvim" },
  ...
  vimwiki = {
    config = { "require('plugs.ft.markdown').vimwiki()" },
    load_after = {},
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'incline.nvim', 'indent-blankline.nvim', 'virtcolumn.nvim', 'lualine.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
