...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "vimwiki", "nvim-scrollbar", "lualine.nvim", "bufferline.nvim", "indent-blankline.nvim", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-regexplainer", "nvim-gps", "nvim-treesitter-endwise", "nvim-tree-docs", "playground", "nvim-treesitter-textobjects" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "telescope-rualdi.nvim", "telescope-ui-select.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-smart-history.nvim", "telescope-packer.nvim", "telescope-ultisnips.nvim", "telescope-hop.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-coc.nvim", "nvim-neoclip.lua", "telescope-file-browser.nvim", "telescope-bookmarks.nvim", "nvim-dap" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'luv-vimdocs', 'nlua.nvim', 'nvim-luaref', 'nvim-luapad', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
