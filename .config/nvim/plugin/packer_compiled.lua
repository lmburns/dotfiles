...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "bufferline.nvim", "nvim-scrollbar", "telescope.nvim", "indent-blankline.nvim", "vimwiki" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-regexplainer", "Comment.nvim", "nvim-treesitter-textobjects", "nvim-treesitter-endwise", "nvim-gps", "nvim-treesitter-refactor", "nvim-tree-docs", "nvim-ts-autotag", "iswap.nvim", "playground", "vim-indent-object", "nvim-ts-context-commentstring" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
  ...
  ["telescope.nvim"] = {
    after = { "nvim-dap", "telescope-file-browser.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-frecency.nvim", "telescope-zoxide", "telescope-fzf-native.nvim", "telescope-ultisnips.nvim", "telescope-coc.nvim", "telescope-ui-select.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "nvim-neoclip.lua", "telescope-packer.nvim", "telescope-bookmarks.nvim", "telescope-rualdi.nvim" },
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'luv-vimdocs', 'nvim-luapad', 'nvim-colorizer.lua', 'nlua.nvim', 'lua-dev.nvim', 'nvim-luaref'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-markdown', 'vim-pandoc-syntax', 'vim-table-mode', 'mkdx'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'nvim-colorizer.lua', 'vim-pandoc-syntax', 'vim-table-mode', 'mkdx'}, { ft = "markdown" }, _G.packer_plugins)]]
