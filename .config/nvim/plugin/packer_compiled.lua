...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "nvim-scrollbar", "telescope.nvim", "nvim-notify", "lf.nvim", "vimwiki", "bufferline.nvim", "indent-blankline.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "todo-comments.nvim", "telescope-heading.nvim", "project.nvim", "telescope-file-browser.nvim", "telescope-ghq.nvim", "telescope-zoxide", "nvim-dap", "telescope-ultisnips.nvim", "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-packer.nvim", "telescope-frecency.nvim", "nvim-neoclip.lua", "telescope-hop.nvim", "lazygit.nvim", "urlview.nvim", "telescope-github.nvim", "telescope-coc.nvim", "telescope-bookmarks.nvim", "telescope-rualdi.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vimwiki', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'mkdx', 'vimwiki', 'vim-markdown'}, { ft = "vimwiki" }, _G.packer_plugins)]]
