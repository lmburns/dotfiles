...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "lualine.nvim", "lf.nvim", "nvim-scrollbar", "bufferline.nvim", "vimwiki", "nvim-notify", "telescope.nvim", "indent-blankline.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "lazygit.nvim", "telescope-ultisnips.nvim", "urlview.nvim", "nvim-dap", "project.nvim", "telescope-hop.nvim", "telescope-heading.nvim", "nvim-neoclip.lua", "telescope-bookmarks.nvim", "telescope-coc.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-smart-history.nvim", "todo-comments.nvim", "telescope-rualdi.nvim", "telescope-packer.nvim", "telescope-zoxide", "telescope-ghq.nvim", "telescope-github.nvim" },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file FSRead lua require("packer.load")({'fsread.nvim'}, { cmd = "FSRead", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
