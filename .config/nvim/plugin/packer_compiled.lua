...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-notify", "nvim-scrollbar", "mkdx", "lf.nvim", "telescope.nvim", "vimwiki", "lualine.nvim", "bufferline.nvim" },
  ...
  ["nvim-FeMaco.lua"] = {
    commands = { "FeMaco" },
    config = { "require('plugs.ft.markdown').femaco()" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/nvim-FeMaco.lua",
  ...
  ["telescope.nvim"] = {
    after = { "nvim-notify", "urlview.nvim", "todo-comments.nvim", "nvim-neoclip.lua", "project.nvim", "telescope-file-browser.nvim", "telescope-smart-history.nvim", "telescope-coc.nvim", "telescope-ultisnips.nvim", "telescope-hop.nvim", "telescope-rualdi.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-heading.nvim", "telescope-zoxide", "telescope-bookmarks.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'telescope-heading.nvim', 'vimwiki'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'telescope-heading.nvim', 'vimwiki'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'incline.nvim', 'virtcolumn.nvim', 'lualine.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
