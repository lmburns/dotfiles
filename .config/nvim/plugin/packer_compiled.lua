...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-notify", "lualine.nvim", "indent-blankline.nvim", "nvim-scrollbar", "bufferline.nvim", "lf.nvim", "vimwiki", "telescope.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "project.nvim", "telescope-bookmarks.nvim", "nvim-dap", "telescope-ultisnips.nvim", "nvim-neoclip.lua", "telescope-zoxide", "urlview.nvim", "todo-comments.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-coc.nvim", "telescope-heading.nvim", "lazygit.nvim", "telescope-rualdi.nvim", "telescope-packer.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim" },
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'vim-markdown', 'vim-table-mode', 'mkdx'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'vim-markdown', 'vim-table-mode', 'mkdx'}, { ft = "markdown" }, _G.packer_plugins)]]
