...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "nvim-scrollbar", "telescope.nvim", "indent-blankline.nvim", "bufferline.nvim", "vimwiki", "lualine.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-regexplainer", "nvim-gps", "nvim-treesitter-endwise", "nvim-tree-docs", "nvim-treesitter-textobjects", "nvim-treesitter-refactor", "playground" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-ghq.nvim", "telescope-fzf-native.nvim", "telescope-hop.nvim", "telescope-smart-history.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "telescope-github.nvim", "telescope-coc.nvim", "telescope-ui-select.nvim", "telescope-file-browser.nvim", "telescope-bookmarks.nvim", "nvim-neoclip.lua", "telescope-rualdi.nvim", "telescope-packer.nvim", "nvim-dap" },
...
try_loadstring("\27LJ\2\n¤\1\0\0\2\0\3\0\0046\0\0\0005\1\2\0=\1\1\0K\0\1\0\1\22\0\0\rftdetect\rmarkdown\frustpeg\alf\bron\ncmake\bcss\6d\tdart\15dockerfile\ago\ngomod\thtml\tjava\tmake\vpython\nquery\truby\trust\tscss\bzig\22polyglot_disabled\6g\0", "setup", "vim-polyglot")
...
vim.cmd [[nnoremap <silent> <Leader>k <cmd>lua require("packer.load")({'nvim-trevJ.lua'}, { keys = "<lt>Leader>k", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[nnoremap <silent> F <cmd>lua require("packer.load")({'hop.nvim'}, { keys = "F", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-pandoc-syntax', 'vim-markdown', 'nvim-colorizer.lua', 'mkdx', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'nvim-luapad', 'nvim-colorizer.lua', 'luv-vimdocs', 'nlua.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
