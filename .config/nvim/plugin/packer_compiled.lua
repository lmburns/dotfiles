...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "bufferline.nvim", "lualine.nvim", "telescope.nvim" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-gps", "nvim-tree-docs", "nvim-treesitter-endwise", "playground", "nvim-treesitter-textobjects", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-github.nvim", "telescope-ultisnips.nvim", "nvim-neoclip.lua", "telescope-ghq.nvim", "telescope-bookmarks.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-coc.nvim" },
...
try_loadstring("\27LJ\2\nd\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0M                  hi! TabLineSel guibg=#ddc7a1 gui=bold\n                \bcmd\0", "setup", "bufferline.nvim")
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown', 'vim-pandoc-syntax'}, { ft = "vimwiki" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-table-mode', 'vim-markdown', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
