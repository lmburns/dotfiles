...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "telescope.nvim", "lualine.nvim", "bufferline.nvim", "lf.nvim", "nvim-notify", "indent-blankline.nvim", "vimwiki", "nvim-scrollbar" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-rualdi.nvim", "telescope-file-browser.nvim", "nvim-dap", "urlview.nvim", "possession.nvim", "project.nvim", "todo-comments.nvim", "telescope-packer.nvim", "telescope-zoxide", "telescope-bookmarks.nvim", "nvim-neoclip.lua", "telescope-hop.nvim", "telescope-heading.nvim", "telescope-smart-history.nvim", "lazygit.nvim", "telescope-ghq.nvim", "telescope-coc.nvim", "telescope-ultisnips.nvim", "telescope-fzf-native.nvim", "telescope-github.nvim", "telescope-frecency.nvim" },
  ...
  ["vim-fugitive"] = {
    ...
    keys = { { "n", "<LocalLeader>gg" }, { "n", "<LocalLeader>ge" }, { "n", "<LocalLeader>gR" }, { "n", "<LocalLeader>gB" }, { "n", "<LocalLeader>gw" }, { "n", "<LocalLeader>gW" }, { "n", "<LocalLeader>gr" }, { "n", "<LocalLeader>gf" }, { "n", "<LocalLeader>gF" }, { "n", "<LocalLeader>gc" }, { "n", "<LocalLeader>gC" }, { "n", "<LocalLeader>gd" }, { "n", "<LocalLeader>gt" } },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'luv-vimdocs', 'nvim-luapad', 'nlua.nvim', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
