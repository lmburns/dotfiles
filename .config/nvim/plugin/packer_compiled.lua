...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "telescope.nvim", "nvim-notify", "bufferline.nvim", "lf.nvim", "lualine.nvim", "indent-blankline.nvim", "nvim-scrollbar", "vimwiki" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-dap", "urlview.nvim", "project.nvim", "telescope-heading.nvim", "todo-comments.nvim", "telescope-ultisnips.nvim", "telescope-zoxide", "lazygit.nvim", "nvim-neoclip.lua", "telescope-bookmarks.nvim", "telescope-file-browser.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-ghq.nvim", "telescope-github.nvim", "telescope-hop.nvim", "telescope-packer.nvim", "telescope-rualdi.nvim", "telescope-coc.nvim", "telescope-smart-history.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdx', 'vim-table-mode', 'vim-markdown', 'vimwiki'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'mkdx', 'vim-table-mode', 'vim-markdown', 'vimwiki'}, { ft = "vimwiki" }, _G.packer_plugins)]]
