...
_G.packer_plugins = {
  ...
  ["close-buffers.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/close-buffers.nvim",
  ...
  ["dial.nvim"] = {
    ...
    keys = { { "n", "+" }, { "n", "_" }, { "v", "+" }, { "v", "_" }, { "v", "g+" }, { "v", "g_" }, { "n", "s-" }, { "n", "s=" }, { "n", "s[" }, { "n", "s]" }, { "n", "s`" }, { "n", "s~" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  kimbox = {
    after = { "telescope.nvim", "bufferline.nvim", "nvim-scrollbar", "vimwiki", "lualine.nvim", "nvim-notify", "lf.nvim" },
  ...
  ["nvim-dap"] = {
    after = { "one-small-step-for-vimkind", "nvim-dap-ui", "nvim-dap-python", "telescope-dap.nvim", "nvim-dap-virtual-text" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ghq.nvim", "telescope-bookmarks.nvim", "telescope-smart-history.nvim", "telescope-coc.nvim", "nvim-neoclip.lua", "telescope-heading.nvim", "telescope-zoxide", "telescope-rualdi.nvim", "telescope-github.nvim", "telescope-file-browser.nvim", "urlview.nvim", "nvim-notify", "telescope-hop.nvim", "todo-comments.nvim", "project.nvim", "telescope-frecency.nvim", "telescope-ultisnips.nvim", "telescope-fzf-native.nvim" },
  ...
  ["vim-ingo-library"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/vim-ingo-library",
...
local module_lazy_loads = {
  ["^close_buffers"] = "close-buffers.nvim",
  ["^nui"] = "nui.nvim"
}
...
pcall(vim.api.nvim_create_user_command, 'SpellCheck', function(cmdargs)
          require('packer.load')({'vim-ingo-library'}, { cmd = 'SpellCheck', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-ingo-library'}, {}, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'SpellLCheck', function(cmdargs)
          require('packer.load')({'vim-ingo-library'}, { cmd = 'SpellLCheck', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-ingo-library'}, {}, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'help', function(cmdargs)
          require('packer.load')({'nvim-luaref', 'luv-vimdocs'}, { cmd = 'help', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'nvim-luaref', 'luv-vimdocs'}, {}, _G.packer_plugins)
...
pcall(vim.cmd, [[nnoremap <unique><silent> qs <cmd>lua require("packer.load")({'vim-ingo-library'}, { keys = "qs", prefix = "" }, _G.packer_plugins)<cr>]])
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'vim-table-mode', 'nvim-colorizer.lua'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType xdefaults ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "xdefaults" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType json ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "json" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-colorizer.lua', 'template-string.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'vimwiki', 'vim-table-mode', 'nvim-colorizer.lua'}, { ft = "vimwiki" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-colorizer.lua', 'template-string.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-luaref', 'luv-vimdocs', 'nvim-colorizer.lua'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType ron ++once lua require("packer.load")({'nvim-colorizer.lua', 'ron.vim'}, { ft = "ron" }, _G.packer_plugins)]]
vim.cmd [[au FileType noice ++once lua require("packer.load")({'nvim-colorizer.lua'}, { ft = "noice" }, _G.packer_plugins)]]
vim.cmd [[au FileType vue ++once lua require("packer.load")({'nvim-ts-autotag'}, { ft = "vue" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-colorizer.lua', 'template-string.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType xml ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-colorizer.lua'}, { ft = "xml" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'vim-ccls'}, { ft = "c" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead {*.o,*.so,*.a,*.out,*.bin,*.exe} ++once lua require("packer.load")({'vim-xxdcursor', 'hexmode'}, { event = "BufRead {*.o,*.so,*.a,*.out,*.bin,*.exe}" }, _G.packer_plugins)]]
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'incline.nvim', 'lualine.nvim', 'noice.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'marks.nvim', 'nvim-scrollbar', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
