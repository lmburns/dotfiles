...
_G.packer_plugins = {
  ...
  kimbox = {
    after = { "indent-blankline.nvim", "vimwiki", "nvim-scrollbar", "bufferline.nvim", "telescope.nvim", "lualine.nvim", "nvim-notify" },
    loaded = true,
    only_config = true
  },
  ["lazygit.nvim"] = {
  ...
  ["telescope.nvim"] = {
    after = { "urlview.nvim", "nvim-neoclip.lua", "todo-comments.nvim", "telescope-ghq.nvim", "telescope-zoxide", "possession.nvim", "telescope-frecency.nvim", "telescope-coc.nvim", "telescope-fzf-native.nvim", "telescope-heading.nvim", "telescope-hop.nvim", "telescope-bookmarks.nvim", "nvim-dap", "telescope-packer.nvim", "telescope-file-browser.nvim", "telescope-ultisnips.nvim", "lazygit.nvim", "telescope-rualdi.nvim", "telescope-github.nvim", "project.nvim", "telescope-smart-history.nvim" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vimwiki', 'vim-markdown', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'luv-vimdocs', 'nvim-luaref', 'nvim-luapad', 'lua-dev.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
