...
syntax region justBuiltInFunctions transparent matchgroup=justBuiltInFunctions start="\v%(env_var_or_default|env_var|extension|file_name|file_stem|parent_directory|without_extension|join|clean|uppercase|lowercase|trim|replace)\ze\(" end=")" oneline contains=@justAllStrings,justBuiltInFunctionParens,justNoise
