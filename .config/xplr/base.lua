...
xplr.config.general.table.col_widths = {
    {Percentage = 10}, {Percentage = 50}, {Percentage = 10}, {Percentage = 10},
    {Percentage = 20}
}
    ...
    key_bindings = {
        on_key = {
            ...
            ["ctrl-f"] = {
                help = "search",
                messages = {
                    "PopMode", {SwitchModeBuiltin = "search"},
                    {SetInputBuffer = ""}, "ExplorePwdAsync"
                }
            },
            ["ctrl-i"] = {
            ...
            ["d"] = {
                help = "delete",
                messages = {"PopMode", {SwitchModeBuiltin = "delete"}}
            },
            ...
            ["f"] = {
                help = "filter",
                messages = {"PopMode", {SwitchModeBuiltin = "filter"}}
            },
            ["g"] = {
                help = "go to",
                messages = {"PopMode", {SwitchModeBuiltin = "go_to"}}
            },
            ...
            ["r"] = {
                help = "rename",
                messages = {
                    "PopMode", {SwitchModeBuiltin = "rename"}, {
                        BashExecSilently = [===[
            ...
            ["s"] = {
                help = "sort",
                messages = {"PopMode", {SwitchModeBuiltin = "sort"}}
            },
            space = {
        ...
        on_number = {
            help = "input",
            messages = {
                "PopMode", {SwitchModeBuiltin = "number"}, "BufferInputFromKey"
            }
        },
...
xplr.config.modes.builtin.recover = {
    ...
    key_bindings = {
        on_key = {
            ["ctrl-c"] = {help = "terminate", messages = {"Terminate"}},
            esc = {help = "escape", messages = {"PopMode"}}
        },
        on_alphabet = nil,
        on_number = nil,
        on_special_character = nil,
        default = {help = nil, messages = {}}
    }
}
    ...
    key_bindings = {
        on_key = {
            ...
            ["d"] = {
                ...
                messages = {
                    "PopMode", {SwitchModeBuiltin = "create directory"},
                    {SetInputBuffer = ""}
                }
            },
            esc = {help = "cancel", messages = {"PopMode"}},
        ...
        on_key = {
            ["!"] = {
                ...
                messages = {
                    ...
                    "ExplorePwdAsync", "PopMode"
                }
            },
            ["c"] = {
                help = "create",
                messages = {"PopMode", {SwitchModeBuiltin = "create"}}
            },
            ["ctrl-c"] = {help = "terminate", messages = {"Terminate"}},
            ["e"] = {
                help = "open in editor",
    ...
    key_bindings = {
        on_key = {
            ...
            left = {
                ...
                messages = {
                    {RemoveNodeFilterFromInput = "IRelativePathDoesContain"},
                    "Back", {SetInputBuffer = ""}, "ExplorePwdAsync"
                }
            },
            right = {
                help = "enter",
                messages = {
                    {RemoveNodeFilterFromInput = "IRelativePathDoesContain"},
                    "Enter", {SetInputBuffer = ""}, "ExplorePwdAsync"
                }
            },
            tab = {
                help = "toggle selection",
...
xplr.config.modes.builtin.search.key_bindings.on_key["esc"] = xplr.config.modes
                                                                  .builtin
                                                                  .search
                                                                  .key_bindings
                                                                  .on_key.enter
...
xplr.config.modes.builtin.filter.key_bindings.on_key["esc"] = xplr.config.modes
                                                                  .builtin
                                                                  .filter
                                                                  .key_bindings
                                                                  .on_key.enter
...
xplr.config.modes.builtin.sort.key_bindings.on_key["esc"] = xplr.config.modes
                                                                .builtin.sort
                                                                .key_bindings
                                                                .on_key.enter
    ...
    key_bindings = {
        on_key = {
            ...
            ["4"] = {
                ...
                messages = {
                    {SwitchLayoutBuiltin = "no_help_no_selection"}, "PopMode"
                }
            },
            ["ctrl-c"] = {help = "terminate", messages = {"Terminate"}},
            esc = {help = "cancel", messages = {"PopMode"}}
